<div class="about-header">
  ...
  <a href="https://github.com/thetpmguy" target="_blank" rel="noopener" style="display:inline-flex;align-items:center;gap:0.5rem;text-decoration:none;color:var(--color-accent-2);">
...
<a href="https://thetpmstory.substack.com"
   target="_blank"
   rel="noopener"
  ...
  <svg viewBox="0 0 24 24"
    ...
    <path d="M3 3h18v3H3V3zm0 5h18v3H3V8zm0 5h18v8l-9-4-9 4v-8z"/>
  </svg>

  <span>Substack</span>
</a>

  <a href="https://www.linkedin.com/in/rahikumar/" target="_blank" rel="noopener" style="display:inline-flex;align-items:center;gap:0.5rem;text-decoration:none;color:var(--color-accent-2);">
  ...
  <a href="mailto:rahikumar0417@gmail.com" style="display:inline-flex;align-items:center;gap:0.5rem;text-decoration:none;color:var(--color-accent-2);">
...
Currently, Building Cost Efficient AI Harness, Agentic AI, Deep Agents, Multi-Agents and AI automation using LangChain, LangSmith,LangGraph, Arize AI, n8n & Leading Authentic “ground up” Team Culture
...
Note: This portfolio is a living document. AI evolves daily, and so does my work. I build in real time, ship fast, and refine continuously. Projects here may shift, expand, or be replaced as I learn, experiment, and push into new territory everyday.
